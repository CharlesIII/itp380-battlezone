...
namespace Battlezone
{
    ...
    /// </summary>
    abstract class GameOverScreen : GameScreen
    {
        #region Fields

        List<GameOverEntry> titleEntries = new List<GameOverEntry>();
        int selectedEntry = 0;
        string menuTitle;
        ...
        /// </summary>
        protected IList<GameOverEntry> TitleEntries
        {
        ...
        /// Constructor.
        /// </summary>
        public GameOverScreen(string menuTitle)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < titleEntries.Count; i++)
            {
                GameOverEntry titleEntry = titleEntries[i];
